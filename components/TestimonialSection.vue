<template>
    <section class="px-20 py-0 mb-16">
      <div class="p-0.5 border-2 border-white border-solid">
        <div
          class="flex justify-between px-3.5 py-8 border-b-2 border-solid border-b-white"
        >
        ...
        <div class="flex gap-20 p-3.5 max-sm:flex-col">
          <img
          ...
          <div class="relative px-20 py-6 max-sm:p-5">
            <div v-html="quoteIcon" class="mb-[60px] opacity-20"></div>
            <p
        ...
        >
          ...
          <div class="flex gap-5 ml-10">
            <div v-html="prevArrow" class="cursor-pointer"></div>
            <div v-html="nextArrow" class="cursor-pointer"></div>
          </div>
        </div>
      </div>
    </section>
